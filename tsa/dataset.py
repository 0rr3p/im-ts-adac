...
class TimeSeriesDataset(object):
    ...
    def frame_series(self, traj_list,traj_ids_list, min_overlap: float = 0.70):
        """
    ...
    def get_loaders(self):
        ...
        test_iter = DataLoader(test_dataset, batch_size=self.batch_size, shuffle=False, drop_last=False)
        return train_iter, test_iter, nb_features
